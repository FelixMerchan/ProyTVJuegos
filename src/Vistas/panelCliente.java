...
public class panelCliente extends JPanel {
	...
	private JLabel lbobservacion = null;
	private JTextField txtObservacion = null;
    ...
    public Cliente leer()
    {
        ...
        if(form_validado()){
            ...
            ob.observacion=txtObservacion.getText();
    ...
    public void quitar_validaciones(){
    	...
    	Validaciones.pinta_text(txtObservacion);
    	frmPrincipal.lbMensaje.setText("");
    }
    ...
    public void ver_registro(int pos)
    {
        if(pos>=0 && pos<list.Count())
        {
            ...
            txtObservacion.setText(ob.observacion);
  ...
  //cedula, apellido,  nombre, telefono, email, ciudad, direccion, observacion
	...
	/**
	 * Este método inicializa btGuardar
	 *
